...
namespace Cassandra.DB
{
    class CassandraConnect
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nFind writer by bookid and authorId:");
            var result7 = session.Execute("SELECT * FROM authors_by_books Where authorId = 2 and bookId = 5;").Select(row => (row.GetValue<string>("name"), row.GetValue<string>("lastname"), row.GetValue<int>("authorid"), row.GetValue<string>("title")));
        ...
        private static void CreateBooksTableByAuthors(ISession session)
        {
            ...
            session.Execute("CREATE TABLE books_by_authors (authorID INT, bookID INT, title TEXT, releaseDate TEXT, name TEXT,lastName TEXT, PRIMARY KEY ((authorID), bookID));");
        ...
        private static void CreateAuthorsTableByBooks(ISession session)
        {
            ...
            session.Execute("CREATE TABLE authors_by_books (authorID INT, bookID INT, title TEXT, releaseDate TEXT, name TEXT,lastName TEXT, PRIMARY KEY ((authorID, bookID)));");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (1, 1,'Hamletas', '1605', 'William', 'Shakespeare' ) IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (1, 2,'Romeo ir Džiuljeta', '1597', 'William', 'Shakespeare') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (1, 3,'Karalius Lyras', '1608', 'William', 'Shakespeare') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,4,'Haris Poteris ir išminties akmuo', '1997', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,5,'Haris Poteris ir paslapčių kambarys', '1998', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,6,'Haris Poteris ir Azkabano kalinys', '1999', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,7,'Haris Poteris ir Ugnies taurė', '2000', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,8,'Haris Poteris ir Fenikso brolija', '2003', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,9,'Haris Poteris ir Netikras Princas', '2005', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,10,'Haris Poteris ir Mirties relikvijos', '2007', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (2,11,'Fantastiniai gyvūnai ir kur juos rasti', '2001', 'Joanne', 'Rowling') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (3,12,'Žmogžudystė Rytų eksprese', '1934', 'Agatha', 'Christie') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (3,13,'Mirtis ant Nilo', '1937', 'Agatha', 'Christie') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (4,14,'Tas', '1986', 'Stephen', 'King') IF NOT EXISTS");
            session.Execute("INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (4,15,'Fairy Tale', '2022', 'Stephen', 'King') IF NOT EXISTS");
            session.Execute(
                "INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (5,16,'Maigret', '1934', 'Georges', 'Simenon') IF NOT EXISTS");
            session.Execute(
                "INSERT INTO authors_by_books (authorID, bookID, title, releaseDate, name, lastName) VALUES (5,17,'The blue room', '1964', 'Georges', 'Simenon') IF NOT EXISTS");
